...
def clean_crime_data():
    ...
    def get_population_data():
        ...
        """
        pop_df = pd.read_csv('full_visualisation/data/map_data/population_state.csv')
    ...
    # Load the CSV file
    df = pd.read_csv('full_visualisation/data/map_data/crime_district.csv')
    ...
    final_result.to_csv('full_visualisation/data/map_data/crime_district_cleaned.csv', index=False)
    print(f"\nCleaned data saved to 'full_visualisation/data/map_data/crime_district_cleaned.csv'")
